...
my $PART_TABLE_FILENAME   = "mediatek/build/tools/ptgen/$PLATFORM/partition_table_${PLATFORM}${FLASH_IC_NAME}.xls"; # excel file name
...
print "PLATFORM = $ENV{MTK_PLATFORM} $ENV{FLASH_IC} ;
PROJECT = $ENV{PROJECT};
LCA_PRJ = $ENV{MTK_LCA_SUPPORT};
PAGE_SIZE = $ENV{MTK_NAND_PAGE_SIZE};
EMMC_SUPPORT= $ENV{MTK_EMMC_SUPPORT};
